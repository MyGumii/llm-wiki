...
5. 관련 문서명이 확실하지 않으면 related_candidates.target은 unknown으로 둔다.
6. Detailed Knowledge 섹션에는 핵심 요약에 들어가지 않은 세부 내용도 보존하라.
7. 출력은 최종 Markdown 하나만 제공하고, 설명 문장을 Markdown 밖에 쓰지 마라.
```
