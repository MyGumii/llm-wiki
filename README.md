...
Andrej Karpathy(전 Tesla AI 총괄, OpenAI 창립 멤버)가 2026년 4월에 공개한 [LLM Wiki 아이디어](https://github.com/MyGumii/llm-wiki/blob/main/llm-wiki.md)는 이 문제를 정면으로 해결합니다. AI가 자료를 받으면 그냥 저장하는 게 아니라, 읽고, 핵심을 정리하고, 기존에 정리해둔 내용과 연결하고, 모순이 있으면 플래그까지 달아놓습니다. 한 번 정리해두면, 새로운 자료가 들어왔을 때 기존 정리 위에 쌓이는 구조입니다.
...
https://github.com/MyGumii/llm-wiki/blob/main/llm-wiki.md
...
- [Karpathy의 LLM Wiki 원문 (GitHub Gist)](https://github.com/MyGumii/llm-wiki/blob/main/llm-wiki.md)
